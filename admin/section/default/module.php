...
echo  "<option value ='0'>เฉพาะครูฯ</option>" ;
echo  "<option value ='1'>ครูฯ และนักเรียน</option>" ;
echo "</select>";
echo "</Td></Tr>";
...
echo  "<option value ='0' selected>เฉพาะครูฯ</option>" ;
}
else{
echo  "<option value ='0'>เฉพาะครูฯ</option>" ;
}
if($ref_result['where_work']==1){
echo  "<option value ='1' selected>ครูฯ และนักเรียน</option>" ;
}
else{
echo  "<option value ='1'>ครูฯ และนักเรียน</option>" ;
}
...
echo "<Tr bgcolor='#FFCCCC'><Td  align='center' width='50'>ที่</Td><Td  align='center' width='170'>ชื่อระบบงานย่อย(อังกฤษ)</Td><Td  align='center'>ชื่อระบบงานย่อย(ไทย)</Td><Td  align='center'>ประเภท</Td><Td  align='center'>กลุ่ม</Td><Td align='center'  width='50'>ลำดับ</Td><Td align='center'  width='90'>สถานะใช้งาน</Td><Td align='center' width='100'>การใช้งาน</Td><Td align='center'  width='50'>ลบ</Td><Td align='center' width='50'>แก้ไข</Td></Tr>";
...
While ($result = mysqli_fetch_array($dbquery))
	{
		...
		$where_work_txt="เฉพาะครู";
		}
		else if($result['where_work']==1){
		$where_work_txt="ครู และนักเรียน";
		}
