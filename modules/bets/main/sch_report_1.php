...
echo "</table>";
	...
	// หาเกณฑ์	
		...
		echo "</td>";
		if($total_percent!=""){
		echo "<td align='center'><a href=?option=bets&task=main/sch_report_1&index=3&sch_test_id=$_GET[sch_test_id]&person_id=$result[student_id]&page=$_REQUEST[page]><img src=images/browse.png border='0'></a></td>";
		}
		else{
		echo "<td></td>";
		}
...
echo "<tr align='center'><td><font color='#006666' size='3'><strong>รายงานผลการสอบ</strong></font></td></tr>";
echo "</table>";
$sql_page = "select *,bets_sch_test.id,bets_sch_test.officer from bets_sch_test left join bets_test on bets_sch_test.test_id=bets_test.id";
...
$sql = "select *,bets_sch_test.id,bets_sch_test.test_id,bets_sch_test.officer from bets_sch_test left join bets_test on bets_sch_test.test_id=bets_test.id order by bets_sch_test.id limit $start,$pagelen";
$dbquery = mysqli_query($connect,$sql);
echo  "<table width='85%' border='0' align='center'>";
