...
#		$a_val=array("0" => "C", "1" => "W", "2" => "S", "3" => "L");
		...
		$nv="";
			for($q=0;$q<count($a_val);$q++)
			{
						...
						$nv[$q]=	mysqli_num_rows(mysqli_query($connect,$l));
			}
			$sv="";
			$all=0;
...
echo "<tr><td align='center'><font color='#990000'>$edu_level[$class_now]$room_now ปีการศึกษา $txtyear_active</font></td></tr>\n";
echo "<tr><td align='center'><font color='#006666'>".thai_date(strtotime($datepicker))."</font></td></tr>\n";
...
<TR  bgcolor='#FFFFFF'>
	<TD colspan=5 align='right'><a href="javascript:history.back();"> |<< ย้อนกลับ</a></TD>
</TR>
<TR  bgcolor='#FFCCCC'>
