...
echo "<TR bgcolor='#FFCCCC' >
	...
	<INPUT TYPE='button' name='smb' value='ลบข้อมูล' onclick='location.href=\"?option=student_check&task=main/check&index=7&class_now=$class_now&room_now=$room_now&datepicker=$check_date&t=$_GET[t]\"'>&nbsp;&nbsp;	<INPUT TYPE=\"reset\" value=' [ รีเซ็ต ] '>&nbsp;&nbsp;$BT_BACK
