...
echo "<Tr><Td align='left'>1. ข้อมูลเดิมอยู่ในรูปแบบไฟล์ Excel  ให้แถวแรกเป็นชื่อหัวสดมภ์ ประกอบด้วย 1.เลขประจำตัวประชาชน 2.คำนำหน้าชื่อ 3.ชื่อ 4.นามสกุล 5.รหัสตำแหน่ง (ไฟล์ตัวอย่าง Download ได้ที่เมนูคู่มือ) </Td></Tr>";
