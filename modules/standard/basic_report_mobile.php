...
echo "<tr align='center'><td><font color='#006666'><strong>มาตรฐานการศึกษาขั้นพื้นฐาน</strong></font></td></tr>";
echo "</table>";
...
function goto_type(val){
	if(val==1){
		callfrm("?option=standard&task=basic_report_mobile");   // page ย้อนกลับ 
		}
}
</script>
