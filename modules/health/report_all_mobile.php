...
<tr>
<td width="100%" height="30" bgcolor="#0066FF"><font color="#FFFFFF"><?php echo $t2;?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        สุขภาพนักเรียนทั้งโรงเรียน ปีการศึกษา 
         ...
         <form name="form1" action="?option=health&&task=report_all_mobile" method="post" enctype="multipart/form-data">
      <tr>
        <td align="right">ปีการศึกษา : 
         <?php
         	$year="SELECT DISTINCT study_year FROM health_base order by base_id desc";
		   		$resultyear=mysqli_query($connect,$year); 
		?>
      ...
      <tr>
        <td width="438" align="right" valign="top">ภาคเรียนที่ 1 <?php if($ck==1 && $tm==1){ echo"<img src='modules/health/iconH/yes.png' width='15' height='15' border='0'>";}?>[<a href="?option=health&task=report_all_mobile&ck=1&tm=1&year_in=<?php echo $year_bs;?>">ครั้งที่ 1</a>]  <?php if($ck==2 && $tm==1){ echo"<img src='modules/health/iconH/yes.png' width='15' height='15' border='0'>";}?>[<a href="?option=health&task=report_all_mobile&ck=2&tm=1&year_in=<?php echo $year_bs;?>">ครั้งที่ 2</a>]&nbsp;&nbsp;</td>
        <td width="444" align="left" valign="top">&nbsp;&nbsp;ภาคเรียนที่ 2 <?php if($ck==1 && $tm==2){ echo"<img src='modules/health/iconH/yes.png' width='15' height='15' border='0'>";}?>[<a href="?option=health&task=report_all_mobile&ck=1&tm=2&year_in=<?php echo $year_bs;?>">ครั้งที่ 1</a>]  <?php if($ck==2 && $tm==2){ echo"<img src='modules/health/iconH/yes.png' width='15' height='15' border='0'>";}?>[<a href="?option=health&task=report_all_mobile&ck=2&tm=2&year_in=<?php echo $year_bs;?>">ครั้งที่ 2</a>]</td>
      </tr>
    </table></td>
  </tr>
  <tr>
      ...
      <?php 
				...
				<?php
					...
					$room=$recordSM['room'];
						...
						$check_room_sd=mysqli_num_rows($resultsd);
        ...
        $sqlslw="SELECT* FROM health_checking WHERE room='$recordSM[room]'&&class_now='$class_code'&&year_std='$year_bs'&&number_check='$ck'&&term_std='$tm'";
		  		$resultslw=mysqli_query($connect,$sqlslw); 
			
				$sqlnox1="SELECT DISTINCT(student_id) FROM health_checking WHERE room='$recordSM[room]'&&class_now='$class_code'&&year_std='$year_bs'&&number_check='$ck'&&term_std='$tm' order by check_id ASC"; 
				$resultnxo1=mysqli_query($connect,$sqlnox1); 
				$checkslw=mysqli_num_rows($resultnxo1);
	...
	{	
      ...
      <tr bgcolor="<?php echo $bg;?>" onMouseOver="this.className='menu-over'" onMouseOut="this.className='menu'" class="menu">
        ...
        <td align="center" valign="middle">[<a href="?option=health&task=report_all_type_room_mobile&class_code=<?php echo $class_code;?>&room=<?php echo $room;?>&year_in=<?php echo $year_bs;?>&ck=<?php echo $ck;?>&tm=<?php echo $tm;?>">รายละเอียด</a>]</td>
		</tr>
             <?php
			 /*******************************/
			 ...
			 /*******************************/
			 	...
			 	$lp++;
					...
					//$room=$recordSM['room'];
						...
						$resultsd2=mysqli_query($connect,$sqlsd2); 
						$check_room_sd2=mysqli_num_rows($resultsd2);
                         ?>
                           <?php
      			$sqlslw2="SELECT * FROM health_checking WHERE class_now='$class_code'&&year_std='$year_bs'&&number_check='$ck'&&term_std='$tm'";  
		  		$resultslw2=mysqli_query($connect,$sqlslw2); 
				
				$sqlnox2="SELECT DISTINCT(student_id) FROM health_checking WHERE class_now='$class_code'&&year_std='$year_bs'&&number_check='$ck'&&term_std='$tm' order by check_id ASC"; 
				$resultnxo2=mysqli_query($connect,$sqlnox2); 
				$checkslw2=mysqli_num_rows($resultnxo2);
						...
						$sum_iodine_no=0;  
							/*}*/
				 $slw2=1;		 						
					while($recordslw2=mysqli_fetch_array($resultslw2))
	{	
      ...
      <tr bgcolor="<?php echo $bg;?>"  onmouseover="this.className='menu-over'" onMouseOut="this.className='menu'" class="menu">
        ...
        <td align="center" valign="middle"><?php echo number_format($sumtotal,2,'.',',');?> %</td>
        <td align="center" valign="middle"><?php echo number_format($sumtotal_no,2,'.',',');?> %</td>
        <td align="center" valign="middle">[<a href="?option=health&task=report_all_type_room_mobile&class_code=<?php echo $class_code;?>&year_in=<?php echo $year_bs;?>&ck=<?php echo $ck;?>&tm=<?php echo $tm;?>">รายละเอียด</a>]</td>
		</tr>
             <?php
			 			 /*******************************/
