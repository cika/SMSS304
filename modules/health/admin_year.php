			...
			if($checkU=="U")
			{
				...
				$sqlU="	UPDATE  health_base
					...
					/*set 1*/	
							...
							WHERE	base_id='$idB'
							LIMIT	1	";
						$resultU2=mysqli_query($connect,$sqlU2);
				}
		}
?>
<head>
...
<br>
<div align="center"> <h2>กำหนดปีการศึกษา</h2></div>
<?php
if(isset($_REQUEST['show'])){
	if($show==3){
?>
  ...
  <tr>
    ...
    <table width="204" border="0" align="center">
      ...
      <tr>
        ...
        <select name="termb" id="termb" class="colortext">
...
//	}
    ...
    <table width="204" border="0" align="center">
      ...
      <tr>
        <td valign="middle">ภาคเรียนที่ :</td>
        <td align="left" valign="middle"><select name="termb" id="termb" class="colortext">
        <option value="<?php echo $recordB['term'];?>"><?php echo $recordB['term'];?></option>
        <option value="1">1</option>
        <option value="2">2</option>
        </select>        </td>
        </tr>
...
<table width="500" border="0" align="center">
  <tr align="center" valign="middle" >
    <td colspan="2" align="left"><input type="button" value=" เพิ่ม " name="add" onclick='location.href="?option=health&show=3&task=admin_year"'></td>
    <td width="99">&nbsp;</td>
    <td width="126">&nbsp;</td>
    <td width="90">&nbsp;</td>
  </tr>
