<?php 
 include "./modules/health/tab.php";
				...
				$resultCKC=mysqli_query($connect,$sqlCKC); 
				$recordCKC=mysqli_fetch_array($resultCKC);
  ...
  <tr>
    <td  valign="top"  height="260"><table width="1200" border="1" cellspacing="0" cellpadding="0">
      ...
      <!--- start check 1 term 1-->
        <?php
				$sqlshow="SELECT* FROM health_checking WHERE student_id='$student_id'&&year_std='$year_bs'&&term_std='1'&&number_check='1' order by check_id ASC";
		  		$resultshow=mysqli_query($connect,$sqlshow); 
				$checkshow=mysqli_num_rows($resultshow);
				$recordshow=mysqli_fetch_array($resultshow);
				...
				$tall=$recordshow['tall']; /*ส่วนสูง*/
						...
						$resultsex=mysqli_query($connect,$sqlsex); 
						$recordsex=mysqli_fetch_array($resultsex); 				
...
<!-- end check 1 term 1 -->
   ...
   <!--- start check 2 term 1-->
        <?php
				$sqlshow2="SELECT* FROM health_checking WHERE student_id='$student_id'&&year_std='$year_bs'&&term_std='1'&&number_check='2' order by check_id ASC";
		  		$resultshow2=mysqli_query($connect,$sqlshow2); 
				$checkshow2=mysqli_num_rows($resultshow2);
				$recordshow2=mysqli_fetch_array($resultshow2);
				...
				$tall2=$recordshow2['tall']; /*ส่วนสูง*/
						...
						$resultsex2=mysqli_query($connect,$sqlsex2); 
						$recordsex2=mysqli_fetch_array($resultsex2); 				
...
<!-- end check 2 term 1 -->
  <!--- start check 1 term 2-->
        <?php
				$sqlshow3="SELECT* FROM health_checking WHERE student_id='$student_id'&&year_std='$year_bs'&&term_std='2'&&number_check='1' order by check_id ASC";
		  		$resultshow3=mysqli_query($connect,$sqlshow3); 
				$checkshow3=mysqli_num_rows($resultshow3);
				$recordshow3=mysqli_fetch_array($resultshow3);
				...
				$tall3=$recordshow3['tall']; /*ส่วนสูง*/
						...
						$resultsex3=mysqli_query($connect,$sqlsex3); 
						$recordsex3=mysqli_fetch_array($resultsex3); 				
...
<!-- end check 1 term 2 -->
      <!--- start check 2 term 2-->
        <?php
				$sqlshow4="SELECT* FROM health_checking WHERE student_id='$student_id'&&year_std='$year_bs'&&term_std='2'&&number_check='2' order by check_id ASC";
		  		$resultshow4=mysqli_query($connect,$sqlshow4); 
				$checkshow4=mysqli_num_rows($resultshow4);
				$recordshow4=mysqli_fetch_array($resultshow4);
				...
				$tall4=$recordshow4['tall']; /*ส่วนสูง*/
						...
						$resultsex4=mysqli_query($connect,$sqlsex4); 
						$recordsex4=mysqli_fetch_array($resultsex4); 				
