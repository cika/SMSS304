...
<Center>
<b>
<Font Size=4 color='#000099'><BR>:::  บันทึกข้อมูล งาน/โครงการ ปีงบประมาณ <?php echo $_SESSION['budget_year']?> :::</Font></b>
<Br><BR><BR>
...
<TABLE width="100%" border="0" borderColor=#FF0033 cellpadding="0" cellspacing="0">
	<tr> 
            <td align="right"  width="50%"><b><font >กลุ่ม(งาน) :</font></b></td>
                    <td align='left' >
                 <?php   
            ...
            <td align="right"  width="50%"><b><font class="textfrm">กลยุทธ์ :</font></b></td>
					...
					$strategic=substr($strategic,0,150);
