...
<br />
<p align="center">
	<Font Size=4 color='#000099'>:::  เพิ่มเจ้าหน้าที่ระบบการวางแผน  :::</Font>
</p>	
<BR>
...
<TABLE  align="center"  width="60%" border="0" borderColor=#FF0033 cellpadding="0" cellspacing="0">
			<tr> 
            <td align="right"><b><font size="3" face="MS Sans Serif">ชื่อ - สกุล</font></b>&nbsp;&nbsp;</td>
                    <td align="left">
		<?php
		echo   "<Select  name='idperson' size='1'  onChange=\"openDir( this.form )\"=>";
		echo  '<option value ="" >เลือกชื่อสมาชิก</option>' ;
...
?>
		...
		?>
	<tr > 
            <td align="right"  width='20%'  ><b><font size="2" face="MS Sans Serif">เลขประจำตัวประชาชน :</font></b></td>
                    <td  align="left"  width='30%' > <input  size=13  type readonly=text name="vid_person" maxlength=13 value=<?php echo $vid_person?>>
					</td></tr>
				<tr> 
                    <td align="right"><b><font size="2" face="MS Sans Serif">add :</font></b></td>
                    <td align="left"><input  type=checkbox  name="vperm_add"  onClick="check( this.form )" > 
                    </td></tr>
					<tr> 
                    <td align="right"><b><font size="2" face="MS Sans Serif">edit :</font></b></td>
                    <td align="left"><input  type=checkbox  name="vperm_edit"  onClick="check( this.form )" >
					</td></tr>
				<tr> 
                    <td align="right"><b><font size="2" face="MS Sans Serif">delete :</font></b></td>
                    <td align="left"><input  type=checkbox  name="vperm_dele"  onClick="check( this.form )" >
					</td></tr>	
               </table>
		</TD>
	 </table>
