...
//::: End valiable array ::://		
					...
					$re=1;
					While ($result_acti = mysqli_fetch_array($dbquery_acti))
						{
...
$space="  ";
echo  "<table width='100%' border='1'  borderColor='#FF0033'  align='center' >";
...
echo "<Td colspan='3' align='center'>รวม</Td><td>$budget_proj_sum</td><Td colspan='2'>&nbsp;</Td></Tr></Table>";
...
callfrm("?option=plan&task=planproject/plan_show_plan_mobile"); 		
}
