...
echo "<ul id=\"nav\" class=\"dropdown dropdown-horizontal\">";
	...
	echo "<li><a href=\"?option=plan\" class=\"dir\">รายงานโครงการ</a>";
		echo "<ul>";
			if($_SESSION['login_status']<=3 or $_SESSION["mpms_add"]==1 or $_SESSION["mpms_edit"] ==1 or $_SESSION["mpms_dele"]==1 or $_SESSION['login_status']==88){	
			echo "<li><a href='?option=plan&task=planproject/money_plan_report'>ตรวจสอบการจัดสรรงบประมาณ</a></li>";
			}
