...
echo "<Tr align='left'><Td align='right'>อื่น ๆ (ถ้ามี)&nbsp;&nbsp;</Td><Td><Input Type='Text' Name='other' Size='60'></Td></Tr>";
echo "</Table>";
echo "<Br>";
...
echo "<Tr bgcolor='#FFCCCC' align='center'><Td width='80'>วันที่</Td><Td width='100'>ห้องประชุม</Td><Td  width='60'>ตั้งแต่เวลา</Td><Td width='60'>ถึงเวลา</Td><Td>วัตถุประสงค์</Td><Td width='100'>จำนวนผู้ประชุม</Td><Td>อื่น ๆ</Td><Td width='100'>ผู้จอง</Td><Td width='150'>วันเวลาจอง</Td><Td width='40'>ลบ</Td><Td width='40'>อนุมัติ</Td><Td>หมายเหตุ</Td></Tr>";
