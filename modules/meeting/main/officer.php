...
echo "<Tr bgcolor='#FFCCCC' align='center'><Td width='80'>วันที่</Td><Td>ห้องประชุม</Td><Td>ตั้งแต่เวลา</Td><Td>ถึงเวลา</Td><Td>วัตถุประสงค์</Td><Td width='100'>จำนวนผู้ประชุม</Td><Td>อื่น ๆ</Td><Td>ผู้จอง</Td><Td width='150'>วันเวลาจอง</Td><Td width='40'><INPUT TYPE='button' name='smb' value='อนุญาต' onclick='goto_url_update2(1)'></Td><Td>ผู้อนุญาต</Td><Td width='90'>หมายเหตุ</Td><Td width='40'>เจ้าหน้าที่</Td></Tr>";
