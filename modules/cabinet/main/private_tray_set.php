...
$dbquery_cabinet = mysqli_query($connect,$sql_cabinet);
$result_cabinet = mysqli_fetch_array($dbquery_cabinet);
...
$result_tray = mysqli_fetch_array($dbquery_tray);
echo "<form id='frm1' name='frm1'>";
echo "<Center>";
...
echo "<Tr  bgcolor='#CCCCCC' align='center'><Td>$result[cabinet_id]</Td><td colspan='3' align='left'>$result[cabinet_name]</td><Td align='center'>$result[cabinet_size]</Td> <Td align='left'>$result[prename]$result[name]&nbsp;$result[surname]</Td>";
								...
								$dbquery_tray= mysqli_query($connect,$sql_tray);
								$tray_num=mysqli_num_rows($dbquery_tray);
								//////////////////////////////////////////
			if(	$tray_num<1){		
