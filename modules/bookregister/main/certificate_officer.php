...
echo "<Td align='right'><INPUT TYPE='checkbox' name='allchk'  id='allchk' onclick='CheckAll()'>เลือก/ไม่เลือกทั้งหมด</Td>";
echo "</tr></table>";
...
echo "<td align='center'><input type='checkbox' name='$id' value='1'></td>";
}
if($delete==1){
...
echo "<tr><td colspan='14'><b>การพิมพ์</b> 0=ไม่พิมพ์ 1=พิมพ์</td></tr>";	
echo "</table>";
echo "</form>";
}  //end index
