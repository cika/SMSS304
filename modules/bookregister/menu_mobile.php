...
if($_SESSION['login_status']<=4){
	echo "<li><a href='?option=bookregister&task=main/receive_mobile' class='dir'>หนังสือรับ</a></li>";
	echo "<li><a href='?option=bookregister&task=main/send_mobile' class='dir'>หนังสือส่ง</a></li>";
}	
echo "</ul>";
echo "</td></tr>";
echo "</table>";
