...
While ($result = mysqli_fetch_array($dbquery_1))
	{
...
$num_rows=mysqli_num_rows($dbquery_num);
		if($num_rows>0){
...
echo "<Tr bgcolor='#FFCCCC' align='center'><Td width='80'>ที่</Td><Td width='300'>ชื่อ</Td><Td width='300'>ตำแหน่ง</Td><Td width='150'>";
