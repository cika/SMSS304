...
echo "<td colspan='3' align='left'>&nbsp;<input type='text' name='subject' size='30'  style='background-color: #E7D8EB'></td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right' height='47'><span lang='th'><font size='2' color='#0000FF'>ข้อความ&nbsp;</font></span></td>";
echo "<td height='47' colspan='3'  align='left'>&nbsp;<textarea rows='10' name='detail' cols='30'  style='background-color: #E6EFE4' ></textarea></td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right' colspan='2'><p align='center'><font size='2' color='#800000'>ไฟล์</font></td>";
echo "<td align='center' colspan='1'><p align='center'><font size='2' color='#800000'>คำอธิบายไฟล์</font></td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right'><font size='2' color='#0000FF'>ไฟล1&nbsp;</font></td>";
echo "<td>&nbsp;<input type='file' name='myfile1' style='background-color: #FFDDFF'></td>";
...
echo "<td>&nbsp;<input type='file' name='myfile2' style='background-color: #FFDDFF'> </td>";
...
echo "<td>&nbsp;<input type='file' name='myfile3' style='background-color: #FFDDFF'> </td>";
...
echo "<td>&nbsp;<input type='file' name='myfile4' style='background-color: #FFDDFF'> </td>";
...
echo "<td>&nbsp;<input type='file' name='myfile5' style='background-color: #FFDDFF'> </td>";
...
echo "<table border='1' width='100%' id='table1' style='border-collapse: collapse' bordercolor='#C0C0C0' align='center'>";
echo "<tr bgcolor='#9900CC'>";
echo "<td colspan='2' height='23' align='left'><font color='#FFFFFF'>&nbsp;รายละเอียดของจดหมาย</font></td>";
echo "</tr>";
echo "<tr>";
echo "<td width='94' align='right'><font size='2' color='#0000FF'>ถึง&nbsp;</font></span></td>";
echo "<td align='left'>";
...
echo "<td align='left'>&nbsp;<input type='text' name='subject' size='30'  style='background-color: #E7D8EB' value='$result[subject]' readonly> </td>";
echo "</tr>";

echo "<tr>";
echo "<td width='94' align='right' height='47'><span lang='th'><font size='2' color='#0000FF'>ข้อความ&nbsp;</font></span></td>";
echo "<td height='47' align='left'>&nbsp;<textarea rows='10' name='detail' cols='30'  style='background-color: #E6EFE4' readonly>$result[detail]</textarea></td>";
echo "</tr>";
...
echo "<table width='100%' align='center'><tr><Td  align='right'><INPUT TYPE='button' name='smb' value='เขียนจดหมาย' onclick='location.href=\"?option=mail&task=main/send_mobile&index=1\"'>";
echo "</td></tr></table>";
echo "</form>";
...
$dbquery = mysqli_query($connect,$sql);
echo  "<table width='100%' border='0' align='center'>";
echo "<Tr bgcolor='#FFCCCC' align='center'><Td>ที่</Td><Td>วันที่ส่ง</Td><Td>เรื่อง</Td><Td>File</Td><Td>ส่งถึง</Td><Td>ลบ</Td></Tr>";
