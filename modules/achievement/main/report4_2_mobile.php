...
<CENTER>
<h3>คะแนนสอบ NT และผลการประเมิน</h3>
...
echo "<Table width='100%' Border='0' Bgcolor='#Fcf9d8'>";
  echo "<Tr bgcolor='#FFCCCC'><Td  align='center' width='16%'>ระดับ</Td><Td  align='center' width='16%'>ความสามารถด้านภาษา</Td><td align='center'  width='16%'>ความสามารถด้านคำนวณ</td><Td align='center'  width='16%'>ความสามารถด้านเหตุผล</Td><Td align='center'  width='16%'>เฉลี่ย</Td><Td align='center' >ผลการประเมิน</Td></Tr>";
  
for($x=1;$x<4;$x++){
			if($ed_year==""){
			$strQuery = "select thai, math, science, score_avg from achievement_main where test_type='2' and test_class='3' and ed_year='$year_ar[1]' and level='$x' ";
			}
			else{
			$strQuery = "select thai, math, science, score_avg from achievement_main where test_type='2' and test_class='3' and ed_year='$ed_year' and level='$x' ";
			}
		...
		if($score_avg>0){
		 echo "<Tr bgcolor=$color><Td  align='left' >$test_level_ar[$x]</Td><Td  align='center'>$thai</Td><td align='center' >$math</td><Td align='center'>$science</Td><Td align='center' >$score_avg</Td><Td align='left' >";
		 //คะแนนจุดตัด
		$a=60;
		$b=30;
		$color[2]="#00CC00";
...
function goto_display(val){
	if(val==1){
		callfrm("?option=achievement&task=main/report4_2_mobile"); 
		}
}
</script>
