...
<td width="880" height="30" bgcolor="#0066FF"><font color="#FFFFFF"><?php echo $t2;?>ออมทรัพย์นักเรียน</font></td>
  ...
  <tr>
	...
	<table width="880" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="118" align="center" valign="middle" bgcolor="#76CEEB">รหัสนักเรียน</td>
	...
	while($recordCK=mysqli_fetch_array($resultCK))
		{	
				...
				$resultSMU=mysqli_query($connect,$sqlSMU); 
				$num2=1;
					while($recordSMU=mysqli_fetch_array($resultSMU)){
