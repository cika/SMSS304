	...
	//save to database
        ...
        <?php if($Test==1){  /* ถ้า Test =1 กรณีบันทึกข้อมูลออมทรัพย์แสร็จแล้ว */
			   ...
			   $sqlmainL="SELECT* FROM student_main_class WHERE class_code='$level'";
				$resultmainL=mysqli_query($connect,$sqlmainL); 
				$rowmainL=mysqli_fetch_array($resultmainL);
										?>
...
<td width="100%" height="30" bgcolor="#0066FF"><font color="#FFFFFF"><?php echo $t2;?>
  ...
  <tr>
    <td bgcolor="#EBEEFE"><div align="right">[ <a href="?option=savings&&task=add_save_day_mobile">ฝากออมทรัพย์</a> ] <font color="#00CC00"><img src="modules/savings/iconS/yes.png" width="16" height="16"><?php echo $t2;?>บันทึกข้อมูลออมทรัพย์เรียบร้อยแล้ว</font><?php echo $t2;?></div>
...
<br><br></td>
	...
	<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
	  ...
	  $sum_report="";
	 	for($k2=1;$k2<=$check_room;$k2++){		
						...
						$recordss=mysqli_fetch_array($resultss);
							//............................................................................
				$c1="#DDF4F9";
			 	$c2="#FEE2FC";
				//..............................................................................
  ...
  <tr>
    <td align="center">[ <a href="?option=savings&&task=add_save_day_mobile">ฝากออมทรัพย์</a> ]</td>
    </tr>
</table>
<br><br>
   	</td>
		...
		$date_show="มกราคม";
			...
			$date_show="พฤศจิกายน";
			 ...
			 if($level!="")
				...
				$resultmenuP0=mysqli_query($connect,$sqlmenuP0); 
				$ckR=mysqli_num_rows($resultmenuP0);
				$rowmenuP0=mysqli_fetch_array($resultmenuP0);
 				$levelR=$rowmenuP0['per_position'];
				$roomR=$rowmenuP0['person_room'];
				if($ckR==0){
					echo "<script>alert('คุณไม่ใช่ครูประจำชั้นห้องนี้'); javascript:window.location='?option=savings&task=add_save_day_mobile'; </script>";
				}else{
					if($room=="" || $room==0)	
					{		
...
<td width="100%" height="30" bgcolor="#0066FF"><font color="#FFFFFF"><?php echo $t2;?>
  ...
  <tr>
    <td>
  <form name="form1" action="?option=savings&&task=add_save_day_mobile" method="post" enctype="multipart/form-data"  onSubmit="return checkfor(this)">
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>&nbsp;&nbsp;ปีการศึกษา :
          <input name="year" type="text" id="year" value="<?php echo $year_last;?>" size="4" maxlength="4"  class="colorbk"  disabled="disabled"  /></td>
		</tr><tr>  
	...
	?>
        ...
        <td align="center"><input type="submit" name="submitH"  value="ค้นหา"   /></td>
        </tr>
    </table>
</form>
    </td>
  ...
  <tr>
    <td  valign="top">
	<form name="form1" action="?option=savings&&task=add_save_day_mobile" method="post" enctype="multipart/form-data">
	<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="48" align="center" valign="middle" bgcolor="#76CEEB">ลำดับ</td>
        <td width="91" align="center" valign="middle" bgcolor="#76CEEB">รหัสนักเรียน</td>
