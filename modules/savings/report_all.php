  ...
  <tr>
	...
	<table width="1000" border="1" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr bgcolor="<?php echo $bg;?>"  onMouseOver="this.className='menu-over'" onMouseOut="this.className='menu'" class="menu">
        ...
        <td align="right" valign="middle"><?php  if($total_save>=0){?><?php  echo number_format($total_save,2,'.',',');?><?php  }?></td>
        <td align="right" valign="middle"><?php  if($total_draw>=0){?><?php echo number_format($total_draw,2,'.',',');?><?php  }?></td>
      ...
      <tr>
        ...
        <td  align="right" valign="middle"><strong>
         <?php  if($total_save_sum>=0){?> <?php echo number_format($total_save_sum,2,'.',',');?><?php  }?>
        </strong></td>
        <td  align="right" valign="middle"><strong>
         <?php  if($total_draw_sum>=0){?> <?php echo number_format($total_draw_sum,2,'.',',');?><?php  }?>
        </strong></td>
        <td  align="right" valign="middle"><strong>
