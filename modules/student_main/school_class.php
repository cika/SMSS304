...
echo "<br>";
echo  "<table width='50%' border='0' align='center'>";
echo "<tr><td align='left'><b>หมายเหตุ</b> การกำหนดรหัส ดังนี้</td></tr>";
echo "<tr><td align='left'>อนุบาล 1 (หลักสูตร 3 ปี) รหัส 1</td></tr>";
echo "<tr><td align='left'>อนุบาล 1 (หลักสูตร 2 ปี) รหัส 2</td></tr>";
echo "<tr><td align='left'>อนุบาล 2 (หลักสูตร 2 ปี) รหัส 3</td></tr>";
echo "<tr><td align='left'>ประถมศึกษาปีที่ 1 รหัส 4</td></tr>";
echo "<tr><td align='left'>ประถมศึกษาปีที่ 2 รหัส 5</td></tr>";
echo "<tr><td align='left'>ประถมศึกษาปีที่ 3 รหัส 6</td></tr>";
echo "<tr><td align='left'>ประถมศึกษาปีที่ 4 รหัส 7</td></tr>";
echo "<tr><td align='left'>ประถมศึกษาปีที่ 5 รหัส 8</td></tr>";
echo "<tr><td align='left'>ประถมศึกษาปีที่ 6 รหัส 9</td></tr>";
echo "<tr><td align='left'>มัธยมศึกษาปีที่ 1 รหัส 10</td></tr>";
echo "<tr><td align='left'>มัธยมศึกษาปีที่ 2 รหัส 11</td></tr>";
echo "<tr><td align='left'>มัธยมศึกษาปีที่ 3 รหัส 12</td></tr>";
echo "<tr><td align='left'>มัธยมศึกษาปีที่ 4 รหัส 13</td></tr>";
echo "<tr><td align='left'>มัธยมศึกษาปีที่ 5 รหัส 14</td></tr>";
echo "<tr><td align='left'>มัธยมศึกษาปีที่ 6 รหัส 15</td></tr>";
echo "</table>";
