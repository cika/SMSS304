...
if($_SESSION['admin_budget']=="budget" or $_SESSION['login_status']==88){
...
if(($_SESSION['login_status']<=4 and $result_permission['p1']==1) or ($_SESSION['login_status']==88)){	
...
if(($_SESSION['login_status']<=4 and $result_permission['p2']==1) or ($_SESSION['login_status']==88)){	
...
if(($_SESSION['login_status']<=4 and $result_permission['p3']==1) or ($_SESSION['login_status']==88)){	
...
if(($_SESSION['login_status']<=4 and $result_permission['p4']==1) or ($_SESSION['login_status']==88)){	
...
if(($_SESSION['login_status']<=4) or ($_SESSION['login_status']==88)){	
	echo "<li><a href='?option=budget' class='dir'>รายงาน</a>";
		echo "<ul>";
			if($_SESSION['login_status']<=3 or $result_permission['p1']==1 or $result_permission['p2']==1 or $result_permission['p3']==1 or $result_permission['p4']==1 or $_SESSION['login_status']==88){
			echo "<li><a href='?option=budget&task=main/money_plan_report'>ตรวจสอบการจัดสรรงบประมาณ</a></li>";
			}
			...
			echo "<li><a href='?option=budget&task=main/report_6'>เอกสารการเงินและบัญชี</a></li>";
			}
		echo "</ul>";
	echo "</li>";
}	
