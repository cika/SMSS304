...
echo "<INPUT TYPE='button' name='smb' value='เพิ่มข้อมูล' onclick='location.href=\"?option=budget&task=category/edit_type&index=1\"'>";
}
echo "</Td></Tr>";
...
While ($result = mysqli_fetch_array($dbquery))
	{
		...
		if(!($_SESSION['login_status']==88)){
		echo "<Td><div align=center><a href=?option=budget&task=category/edit_type&index=2&id=$id&page=$page><img src=images/drop.png border='0' alt='ลบ'></a></div></Td>
...
echo "<br>";
echo  "<table width=70% border=0 align=center>";
echo "<tr><td><b>หมายเหตุ</b> รหัส 118 ให้ใช้เฉพาะประเภทเงินอาหารกลางวัน<b>เท่านั้น</b> เนื่องจากใช้อ้างอิงในรายงานคงเหลือประจำวัน</td></tr>";
echo "</table>";
?>
<script>
