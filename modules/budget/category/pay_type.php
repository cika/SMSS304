...
echo "<INPUT TYPE='button' name='smb' value='เพิ่มข้อมูล' onclick='location.href=\"?option=budget&task=category/pay_type&index=1\"'>";
}
echo "</Td></Tr>";
...
While ($result = mysqli_fetch_array($dbquery))
	{
		...
		if(!($_SESSION['login_status']==88)){
		echo "<Td><div align=center><a href=?option=budget&task=category/pay_type&index=2&id=$id&page=$page><img src=images/drop.png border='0' alt='ลบ'></a></div></Td>
