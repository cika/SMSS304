...
echo "<INPUT TYPE='button' name='smb' value='เพิ่มเจ้าหน้าที่' onclick='location.href=\"?option=budget&task=main/permission&index=1\"' ";
}
echo "</Td></Tr>";
...
While ($result = mysqli_fetch_array($dbquery))
	{
		...
		if(!($_SESSION['login_status']==88)){
		echo "<Td align='center' width='50' ><a href=?option=budget&task=main/permission&index=2&id=$id><img src=images/drop.png border='0' alt='ลบ'></a></Td>
