...
$dbquery = mysqli_query($connect,$sql);
$num_rows=mysqli_num_rows($dbquery); //นำไปแบ่งหน้า
While ($result = mysqli_fetch_array($dbquery)) {
...
echo "<INPUT TYPE='button' name='smb' value='ลงทะเบียน' onclick='location.href=\"?option=budget&task=main/return_withdraw&index=1\"'>";
}
echo "</Td></Tr>";
