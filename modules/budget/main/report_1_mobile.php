...
echo "<tr align='center'><td><font color='#006666'><strong>รายงานการใช้จ่ายงบประมาณ</strong></font></td></tr>";
echo "<tr align='center'><td><font  color='#006666'>$_SESSION[school_name]</font></td></tr>";
echo "<tr align='center'><td><font  color='#006666'>$today</font></td></tr>";
echo "</table>";
...
echo "<form  name='frm1'>";
	...
	echo "<Select  name='year_index' size='1' onchange='goto_url(1)'>";
...
echo "</select>";
//echo "&nbsp;<INPUT TYPE='button' name='smb' value='เลือก' onclick='goto_url(1)'>";
echo "</td></tr></table>";
echo "</form>";	
/////////////////////
echo  "<table width='100%' border='0' align='center'>";
echo "<Tr bgcolor=#FFCCCC align=center class=style2><Td>ที่</Td><Td>รหัส</Td><Td>โครงการ</Td><Td>กิจกรรม</Td><Td>งบประมาณ</Td><Td>ใช้จ่าย</Td><Td>คงเหลือ</Td><Td>%จ่าย</Td></Tr>";
...
{		
		...
		echo "<Tr bgcolor=#FFFFC class=style1><Td align=center>$i</Td><Td><font color=#00FFFF>$code_proj_plan_ar[$i]</font></Td><Td   colspan=2>$name_proj_plan_ar[$i]</Td><Td align=right><font color='#00FF00'>$budget_project</font></Td><Td align=right>$proj_sum</Td><Td align=right>$net_proj2</Td><Td align=right>$proj_percent</Td></Tr>";		
		$acti_num=0;
		for($x=1;$x<$re;$x++)
		{
				if($code_proj_plan_ar[$i]==$code_proj_acti_ar[$x])
...
echo "<Tr bgcolor=#FFCCCC align=center class=style1><Td colspan='4'>รวม</Td><Td>$sum_momey_proj</Td><Td>$total_withdraw</Td><Td>$total_net</Td><Td>$spt_percent</Td></Tr>";
echo "</Table>";
?>
