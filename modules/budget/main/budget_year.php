...
echo "<INPUT TYPE='button' name='smb' value='เพิ่มปีงบประมาณ' onclick='location.href=\"?option=budget&task=main/budget_year&index=1\"'";
}
echo "</Td></Tr>";
...
While ($result = mysqli_fetch_array($dbquery))
	{
		...
		if(!($_SESSION['login_status']==88)){
		echo "<Td align='center'><a href=?option=budget&task=main/budget_year&index=2&id=$id&page=$page><img src=images/drop.png border='0' alt='ลบ'></a></a></Td>
