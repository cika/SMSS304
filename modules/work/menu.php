...
echo "<ul id='nav' class='dropdown dropdown-horizontal'>";
	...
	echo "<li><a href='?option=work' class='dir'>บันทึกข้อมูล</a>";
		echo "<ul>";
			echo "<li><a href='?option=work&task=check'>บันทึกข้อมูลการปฏิบัติงานวันนี้</a></li>";
			echo "<li><a href='?option=work&task=check_2'>บันทึกข้อมูลการปฏิบัติงานย้อนหลัง</a></li>";
	echo "</ul>";
	echo "</li>";
	}	
	...
	echo "<li><a href='?option=work' class='dir'>รายงาน</a>";
		echo "<ul>";
			echo "<li><a href='?option=work&task=report_1'>สรุปการปฏิบัติงานการรายวัน</a></li>";
			echo "<li><a href='?option=work&task=report_2'>สรุปการปฏิบัติงานรอบเดือน</a></li>";
		echo "</ul>";
	echo "</li>";
	}
	echo "</li>";
	echo "<li><a href='?option=work' class='dir'>คู่มือ</a>";
		echo "<ul>";
				echo "<li><a href='modules/work/manual/work.pdf' target='_blank'>คู่มือการปฏิบัติงาน</a></li>";
		echo "</ul>";
	echo "</li>";
echo "</ul>";
echo "</td></tr>";
