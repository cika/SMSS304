...
$today=date("Y-m-d");
if($_SESSION['school_type']==1){
echo "<tr align='center'>
	<td align=center><font color='#990000' size='3'><strong>บันทึกข้อมูลการปฏิบัติงาน</strong></font>
...
echo "<Td>ลบ</Td>";
if($_SESSION['school_type']==1){
echo "<Td>ชื่อ</Td><Td>ตำแหน่ง</Td><Td>มา</Td><Td>ไปปฏิบัติงาน<br>นอกสถานศึกษา</Td><Td>ลาป่วย</Td><Td>ลากิจ</Td><Td>ลาพักผ่อน</Td><Td>ลาคลอด</Td><Td>ลาอื่นๆ</Td><Td>มาสาย</Td><Td>ไม่มา</Td><Td></Td></Tr>";
}
else{
...
if($_SESSION['school_type']==1){
echo "<Td><input type='radio' name='$person_id' id='$person_id' value='2' $check_index2>ไปปฏิบัติงาน</Td>";
}
else{
...
echo "<Td colspan='14' align='center'><input type='checkbox' name='allchk' id='allchk' onclick='CheckAll()'>เลือก/ไม่เลือก มาทั้งหมด</Td>";
}
echo "</Tr>";
echo "</Table>";
echo "<br>";
...
if($_SESSION['school_type']==1){
echo "&nbsp;&nbsp;&nbsp;&nbsp;2.พื้นแถว<font color='#00FFFF'>สีเขียว</font> หมายถึง ขออนุญาตไปปฏิบัติงานนอกสถานศึกษา<br>";
}
else{
